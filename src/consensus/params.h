...
struct Params {
    ...
    //////////////////////////////////////////////////
    // WATTx Gapcoin PoW Parameters (Hybrid Consensus)
    //////////////////////////////////////////////////

    /** Minimum shift value for prime calculation (controls search space) */
    uint32_t nGapcoinShiftMin{14};

    /** Maximum shift value */
    uint32_t nGapcoinShiftMax{65536};

    /** Initial difficulty (merit target) for Gapcoin PoW */
    double nGapcoinInitialDifficulty{20.0};

    /** Block reward share for miner (PoW) - percentage */
    int nGapcoinMinerRewardPercent{50}; // 50% to miner
